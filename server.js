...
app.post('/registerExit', function(request, response){
    ibmdb.open(cn, async function (err,conn) {
        ...
        if (err){
            ...
            update_in_camp=  'UPDATE QGJ93840.DEVICES SET  "in_campus" = 0 WHERE DEVICE_ID = ' + params['request_id']
            update_last_exit = 'UPDATE QGJ93840.DEVICES SET  ""last_exit_date" " = CURRENT_TIMESTAMP WHERE DEVICE_ID = ' + params['request_id']
