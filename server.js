        ...
        if (err){
            ...
            for (let i = 0; i < params.length-1; i++) {
                var request_query = 
                        ...
                        params[i]['device_id'] +
                        ", DEFAULT, DEFAULT, TIMESTAMP_FORMAT(" +"'"+params[i]['return_date']+"', 'YYYY-MM-DD HH24:MI:SS'), DEFAULT)";
                var device_query = 
            ...
            var request_query = 
                    ...
                    ", DEFAULT, DEFAULT, TIMESTAMP_FORMAT(" +"'"+params[params.length-1]['return_date']+"', 'YYYY-MM-DD HH24:MI:SS'), DEFAULT)";
